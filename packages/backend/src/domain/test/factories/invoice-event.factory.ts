...
import { InvoiceEvent, CreateInvoiceEventProps } from '../../entities/invoice-event.entity';
...
export const createInvoiceEvent = (overrides?: Partial<CreateInvoiceEventProps>): InvoiceEvent => {
